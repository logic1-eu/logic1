"""Generic abstract classes specify terms, and variables at the first-order
level, where the syntax and semantics of the underlying theories is unknown. The
...
from logic1.firstorder.formula import τ, χ, σ
...
class VariableSet(ABC, Generic[χ]):
...
class Term(ABC, Generic[τ, χ, σ, κ]):
